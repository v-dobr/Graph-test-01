...
|:----------------|:-------|:-------------------------------------------------------------------------------------------------------|
| *client_id*     | string | Идентификатор клиента, созданный для приложения. Это значение ** клиента** вашего приложения, указанное в реестре приложений клиента Azure.                                                                  |
...
| *ресурс*   | string | Ресурс, к которому нужно получить доступ. Чтобы вызвать API Microsoft Graph, задайте для этого параметра значение "https://graph.microsoft.com/".|
...
| *refresh_token* | string | Токен обновления, полученный ранее.    |
| *ресурс*      | string | Ресурс, к которому нужно получить доступ.|
...
По синтаксису и семантике этот ответ не отличается от ответа на запрос на получение первого маркера (отсутствует только свойство `id_token`). 
